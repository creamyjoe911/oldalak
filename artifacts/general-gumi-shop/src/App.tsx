...
function App() {
  ...
  return <div className="site-shell">
    ...
    <main>
      ...
      <section className="brand-band" id="markak"><div className="container brand-band-inner"><div><div className="section-kicker">Hivatalos képviselet</div><h2>Ismerős márkák. Műhelybiztos választás.</h2><p>Olyan gyártókkal dolgozunk, akikben mi is megbízunk nap mint nap.</p></div><div className="brand-logos"><img className="brand-logo" src="/images/asset-10.jpg" alt="TRUFLEX PANG" /><img className="brand-logo" src="/images/asset-11.jpg" alt="Perfect Equipment" /><img className="brand-logo" src="/images/asset-17.png" alt="Gaither" /></div></div></section>
